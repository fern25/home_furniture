        ...
        <div class="col-sm-5">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4>Admin Panel</h4>
                    <button class="btn btn-warning">Login Panel</button>
                    <button class="btn btn-warning">Register Panel</button>
                    <button class="btn btn-warning">Reset Password Panel</button>
                </div>
